class op_2_targetColumnVehicle: TaskDefaults {
	scope = 1;
	typeID = 2;
	...
	class TaskDetails {
		...
		description[] = {
			...
			,"<t size='1.1' color='#FFC600'>Brief:</t> <t>A UAV conducting a surveillance flight over %6 has spotted %8 support vehicles operating in the area. This incursion is a direct threat to both %7 operations and civilian traffic and is likely supplying local %8 forces operating around the area.</t>"
			,"<t size='1.1' color='#FFC600'>Action:</t> <t>%7 forces will move to %6 and conduct a sweep to eliminiate any support vehicles and hostile %8 forces.</t>"
			,"<t size='1.1' color='#FFC600'>Intel:</t> <t>As many as three %8 signitures where detected to be operating in the area however the report could not confirm if civilian vehicles where identified.</t>"
