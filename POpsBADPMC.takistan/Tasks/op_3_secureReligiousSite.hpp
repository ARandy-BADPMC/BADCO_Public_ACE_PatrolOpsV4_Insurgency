class op_3_secureReligiousSite: TaskDefaults {
	scope = 1;
	typeID = 3;
	positionSearchTypes[] = {"Home","Farm"};
...
class op_3_secureReligiousSite_INS: TaskDefaults {
	scope = 1;
	typeID = 3;
	positionSearchTypes[] = {"Home","Farm"};
	positionSearchRadius = 1000;
