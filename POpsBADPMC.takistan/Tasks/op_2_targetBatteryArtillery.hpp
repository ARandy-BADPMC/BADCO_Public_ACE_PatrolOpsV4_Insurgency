class op_2_TargetBatteryArtillery: TaskDefaults {
	scope = 1;
	typeID = 2;
	...
	class TaskDetails {
		...
		description[] = {
			...
			,"<t size='1.1' color='#FFC600'>Brief:</t> <t>Artillery shells have fallen into the water near the %7 base and  civilians in %6 have reported hearing loud weapons fire near their vicinity. Satellite recon shows %8 forces have deployed an artillery battery in the vicinity of %8.</t>"
			,"<t size='1.1' color='#FFC600'>Action:</t> <t>%7 forces will move to %6 and conduct a sweep to eliminiate any artillery platforms and any hostile forces.</t>"
			,"<t size='1.1' color='#FFC600'>Intel:</t> <t>%8 have deployed at least one heavy artillery platform but there could be as many as three operating in the area with a support crew as well as a likelyhood of additional ground forces.</t>"
